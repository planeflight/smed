...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -lharfbuzz -pthread -lm -lfreetype -lbz2 -lz -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lglib-2.0 -lm -pthread -lpcre2-8 -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.2.20
